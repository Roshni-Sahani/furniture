  ...
  return (
    <div className="bg-[#243040]">
      <div className="max-w-[1320px] mx-auto px-3">
        <div className="flex-row flex-wrap flex pt-[87px] pb-20 -mx-3">
          <div
            className="xl:w-7/12 lg:w-5/12 px-3 w-full mb-10 md:mb-0"
            data-aos="zoom-in-up"
            data-aos-duration="3000"
          >
            <div className="flex items-center gap-2">
              <img src={footlogo} alt="logo" />
              <p className="text-white  font-bold font-roboto text-[33px]">
                FURNITURE
              </p>
            </div>
            <p className="text-white text-sm font-poppins font-normal max-w-[338px] pt-8 pb-6">
            ...
            <div className="flex gap-3 grou p">
              <a
          ...
          <div
            className="xl:w-5/12 lg:w-7/12 px-3 w-full"
            data-aos="zoom-in-down"
            data-aos-duration="3000"
          >
            <div className="flex-row flex flex-wrap -mx-3">
              <div className="sm:w-4/12 w-1/2 px-3 mb-5 sm:mb-0">
                <ul>
                  <li className="mb-6 text-sm text-white font-roboto font-medium border-b border-solid border-[#BD7D41] w-[130px]">
                    ABOUT STORE
                  </li>
                  <li className="pb-3">
                    <a
                      href=""
                      className="text-sm text-white font-roboto font-normal hover:text-[#BD7D41] duration-500 transition-all"
                    >
                      Home
                    </a>
                  </li>
              ...
              <div className="sm:w-4/12 w-1/2 px-3 mb-5 sm:mb-0">
                <ul>
                  ...
                  <li className="pb-3">
                    <a
                      href=""
                      className="text-sm text-white font-roboto font-normal cursor-pointer  hover:text-[#BD7D41] duration-500 transition-all"
                    >
                      Album
                    </a>
                  </li>
      ...
      <div className="w-full border-solid border-[#91979f] border"></div>
      <p className="text-white text-center text-sm font-roboto py-8 font-normal">
        @copyright2021
      </p>
    </div>
  );
