...
import sliderimg1 from "../assests/images/sliderimg1.webp";
import sliderimg2 from "../assests/images/sliderimg2.webp";
import sliderimg3 from "../assests/images/sliderimg3.webp";
        ...
        <div className="flex flex-wrap flex-row -mx-3">
          <div className="lg:w-5/12 w-full ">
            <div>
              ...
              <h2 className=" pt-[29px] text-[35px] font-poppins text-center lg:text-start mx-auto lg:mx-0 font-bold leading-normal max-w-[436px]">
              ...
              <div className="flex gap-[14px] pt-[39px] justify-center lg:justify-start mb-5">
                ...
                <button
                  className="w-[41px] h-[41px] rounded-[10px] bg-white flex justify-center items-center group duration-500 transition-all hover:bg-black"
          ...
          <div className="lg:w-7/12 min-[890px]:mt-0 mt-[50px] w-full lg:absolute right-0 ">
            <Slider ref={btn} {...settings} className="absolute right-0">
              {card}
            </Slider>
          </div>
        </div>
