  ...
  return (
    <div className="lg:min-h-screen">
      <div className="container max-w-[1320px] px-3 mx-auto">
        <div className="flex py-[15px] justify-between items-center">
          ...
          >
            <li>
              <Link
                to="/"
                className="text-white relative after:absolute after:w-0 after:h-[3px] after:hover:left-0  after:bg-[#BD7D41] transition-all after:left-[50%] after:duration-700 hover:after:w-full after:bottom-[-12px] font-roboto text-lg font-bold"
              >
                {" "}
                HOME
              </Link>
        ...
        <div
          className="flex flex-col justify-center items-center lg:pt-28 pt-[50px] max-lg:pb-[140px]"
          data-aos="zoom-in"
        ...
        >
          ...
          <p
            className="text-white font-poppins md:text-xl text-lg text-center font-normal md:pt-[15px] pt-2"
            data-aos="zoom-in"
            data-aos-duration="3000"
          >
